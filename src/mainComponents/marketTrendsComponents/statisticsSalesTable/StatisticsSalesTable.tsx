...
const StatCell = ({
  ...
  <div className="flex flex-col items-center">
    ...
    <span
      className={`flex items-center text-xs ${positive ? "text-green-600" : "text-red-500"}`}
    >
            ...
            {ROWS.map((row, i) => (
              <tr key={i} className={i % 2 ? "bg-[#F3F3F3]" : "bg-white"}>
                ...
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.sold.toString()} positive={false} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.avgPrice} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.medianPrice} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.medianPSF.toString()} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.volume.toString()} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.discount} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.dom} positive={false} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.inventory.toString()} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.months.toString()} />
                </td>
                <td className="px-4 py-3 text-center">
                  <StatCell value={row.listings.toString()} />
                </td>
              </tr>
            ))}
          </tbody>
...
export default StatisticsSaleTable;

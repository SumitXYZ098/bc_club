...
export default function PropertiesPage() {
  ...
  const pillBase =
    "px-6 py-3 bg-white rounded-full shadow appearance-none pr-10 font-medium cursor-pointer border transition";
      ...
      <div className="h-full mt-24">
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap mb-6">
          <button
            ...
            className="px-6 py-3 bg-white rounded-full shadow flex items-center gap-3 border-[#30548733] cursor-pointer"
          >
          ...
          <button
            ...
            className="px-6 py-3 bg-white rounded-full shadow flex items-center gap-2 border-[#30548733] cursor-pointer"
          >
        ...
        <div className="flex justify-between items-start mb-10 w-full">
          <div className="xl:flex bg-gray-200 rounded-xl h-[600px] w-full sm:w-[300px] md:w-[350px] xl:w-[35%] hidden">
            <Image
              src={Images.map}
              alt="Map"
              width={1400}
          ...
          <div className="flex flex-wrap gap-y-7 justify-between overflow-y-scroll h-[600px] no-scrollbar p-3 xl:w-[64%] w-full">
